...
print(f"[main] Isaac device set to {args_cli.device}")
...
enable_monitor = _physx_monitor_needed(args_cli.task_name) and os.environ.get("ROBODOJO_DISABLE_PHYSX_MONITOR", "0") != "1"
